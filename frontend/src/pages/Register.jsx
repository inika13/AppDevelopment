...
function Register() { 
  ...
  const handleSubmit = async(e)=>{
    ...
    {
      await axios.post("http://localhost:8080/auth/register",{username,email,phone
      ,password});
        ...
        <div className='auth-wrapper'>
          <form className='auth-form app-x-shadow' onSubmit={handleSubmit}>
            <h1 className='auth-heading'>Registration Form</h1>
              ...
              <Link to='/Login'><button type='submit' className='auth-btn app-x-shadow'> Register </button></Link>
          </form>
